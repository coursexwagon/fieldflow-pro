...
// From email address (you can customize this)
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #0A0A0B; color: #FAFAFA; padding: 40px 20px;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #141416; border-radius: 16px; padding: 40px; border: 1px solid #27272A;">
        <div style="text-align: center; margin-bottom: 40px;">
          <h1 style="color: #F97316; margin: 0; font-size: 28px;">⚡ FieldFlow</h1>
        </div>
        ...
        <p style="color: #A1A1AA; font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
          Thanks for joining FieldFlow Pro! You're now ready to start managing your field service business like a pro.
        </p>
        ...
        <div style="background-color: #1C1C1F; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          ...
          <ul style="color: #A1A1AA; font-size: 16px; line-height: 1.8; margin: 0; padding-left: 20px;">
            ...
            <li>📤 Send invoices in 10 seconds</li>
            <li>📷 Document work with photos</li>
            <li>👥 Manage your customers</li>
          </ul>
        </div>
        
        <a href="${process.env.NEXTAUTH_URL}/app" style="display: inline-block; background: linear-gradient(180deg, #F97316 0%, #EA580C 100%); color: white; padding: 16px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">
          Go to Dashboard →
        </a>
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #0A0A0B; color: #FAFAFA; padding: 40px 20px;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #141416; border-radius: 16px; padding: 40px; border: 1px solid #27272A;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
          <h1 style="color: #F97316; margin: 0; font-size: 24px;">⚡ FieldFlow</h1>
        ...
        <div style="text-align: right; margin-bottom: 32px;">
          <p style="color: #A1A1AA; font-size: 16px;">Total: <span style="color: #F97316; font-size: 24px; font-weight: 700;">$${total.toFixed(2)}</span></p>
        </div>
  ...
  const html = `
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #0A0A0B; color: #FAFAFA; padding: 40px 20px;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #141416; border-radius: 16px; padding: 40px; border: 1px solid #27272A;">
        ...
        <a href="${resetUrl}" style="display: inline-block; background: linear-gradient(180deg, #F97316 0%, #EA580C 100%); color: white; padding: 16px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">
          Reset Password
        </a>
